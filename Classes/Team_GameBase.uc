	...
	if ((DamageType == class'DamTypeAssaultGrenade' || DamageType == class'DamType_AssaultGrenade' ) && (PlayerController(Killed) != Killer.PlayerReplicationInfo))
            {
					...
					PlayerController(Killer).ReceiveLocalizedMessage(class'Message_Grenade4',1);
...
//     AllowServerSaveSettings=True
     ...
     DefaultEnemyRosterClass="3SPNCv42109e.TAM_TeamInfo"
     ...
     ScoreBoardType="3SPNCv42109e.TAM_Scoreboard"
     HUDType="3SPNCv42109e.TAM_HUD"
     GoalScore=10
     TimeLimit=0
     ...
     GameReplicationInfoClass=Class'3SPNCv42109e.Misc_BaseGRI'
     GameName="BASE"
