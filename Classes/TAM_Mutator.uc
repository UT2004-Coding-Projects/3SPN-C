...
defaultproperties
{
	 ...
	 WeaponInfo(9)=(WeaponName="UTClassic.ClassicSniperRifle",Ammo[0]=5,MaxAmmo[0]=1.500000)
     EnableNewNet=True
     ...
     NewNetWeaponClasses(0)=Class'3SPNCv42109e.NewNet_ShockRifle'
     NewNetWeaponClasses(1)=Class'3SPNCv42109e.NewNet_LinkGun'
     NewNetWeaponClasses(2)=Class'3SPNCv42109e.NewNet_MiniGun'
     NewNetWeaponClasses(3)=Class'3SPNCv42109e.NewNet_FlakCannon'
     NewNetWeaponClasses(4)=Class'3SPNCv42109e.NewNet_RocketLauncher'
     NewNetWeaponClasses(5)=Class'3SPNCv42109e.NewNet_SniperRifle'
     NewNetWeaponClasses(6)=Class'3SPNCv42109e.NewNet_BioRifle'
     NewNetWeaponClasses(7)=Class'3SPNCv42109e.NewNet_AssaultRifle'
     NewNetWeaponClasses(8)=Class'3SPNCv42109e.NewNet_ShieldGun'
     NewNetWeaponClasses(9)=Class'3SPNCv42109e.NewNet_ClassicSniperRifle'	 
     NewNetWeaponNames(0)="3SPNCv42109e.NewNet_ShockRifle"
     NewNetWeaponNames(1)="3SPNCv42109e.NewNet_LinkGun"
     NewNetWeaponNames(2)="3SPNCv42109e.NewNet_MiniGun"
     NewNetWeaponNames(3)="3SPNCv42109e.NewNet_FlakCannon"
     NewNetWeaponNames(4)="3SPNCv42109e.NewNet_RocketLauncher"
     NewNetWeaponNames(5)="3SPNCv42109e.NewNet_SniperRifle"
     NewNetWeaponNames(6)="3SPNCv42109e.NewNet_BioRifle"
     NewNetWeaponNames(7)="3SPNCv42109e.NewNet_AssaultRifle"
     NewNetWeaponNames(8)="3SPNCv42109e.NewNet_ShieldGun"
     NewNetWeaponNames(9)="3SPNCv42109e.NewNet_ClassicSniperRifle"	 
