...
function string SwapDefaultCombo(string ComboName)
{
    if(ComboName ~= "xGame.ComboSpeed")
        return "3SPNCv42109e.Freon_ComboSpeed";
...
defaultproperties
{
     ...
     TeleportSound=Sound'3SPNCv42109e.Teleport'
     bDisableTeamCombos=False
     TeamAIType(0)=Class'3SPNCv42109e.Freon_TeamAI'
     TeamAIType(1)=Class'3SPNCv42109e.Freon_TeamAI'
     DefaultPlayerClassName="3SPNCv42109e.Freon_Pawn"
     ScoreBoardType="3SPNCv42109e.Freon_Scoreboard"
     HUDType="3SPNCv42109e.Freon_HUD"
     MapListType="3SPNCv42109e.MapListFreon"
     PlayerControllerClassName="3SPNCv42109e.Freon_Player"
     GameReplicationInfoClass=Class'3SPNCv42109e.Freon_GRI'
     GameName="Freon"
