...
static function FillPlayInfo(PlayInfo PI)
{
    ...
    PI.AddSetting("3SPN", "bModifyShieldGun", "Use Modified Shield Gun", 0, 60, "Check");
    ...
    PI.AddSetting("3SPN", "AssaultAmmo", "Assault Ammunition", 0, 64, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "AssaultGrenades", "Assault Grenades", 0, 65, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "BioAmmo", "Bio Ammunition", 0, 66, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "ShockAmmo", "Shock Ammunition", 0, 67, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "LinkAmmo", "Link Ammunition", 0, 68, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "MiniAmmo", "Mini Ammunition", 0, 69, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "FlakAmmo", "Flak Ammunition", 0, 70, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "RocketAmmo", "Rocket Ammunition", 0, 71, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "LightningAmmo", "Lightning Ammunition", 0, 72, "Text", "3;0:999",, True);
    PI.AddSetting("3SPN", "ClassicSniperAmmo", "ClassicSniper Ammunition", 0, 73, "Text", "3;0:999",, True);
...
function string SwapDefaultCombo(string ComboName)
{
    if(ComboName ~= "xGame.ComboSpeed")
        return "3SPNCv42109e.Misc_ComboSpeed";
    else if(ComboName ~= "xGame.ComboBerserk")
        return "3SPNCv42109e.Misc_ComboBerserk";
...
defaultproperties
{
     ...
     OvertimeSound=Sound'3SPNCv42109e.Sounds.overtime'
     ADR_MinorError=-5.000000
     LoginMenuClass="3SPNCv42109e.Menu_TAMLoginMenu"
     LocalStatsScreenClass=Class'3SPNCv42109e.Misc_StatBoard'
     DefaultPlayerClassName="3SPNCv42109e.Misc_Pawn"
     ScoreBoardType="3SPNCv42109e.AM_Scoreboard"
     HUDType="3SPNCv42109e.AM_HUD"
     MapListType="3SPNCv42109e.MapListArenaMaster"
     GoalScore=5
     MaxLives=1
     TimeLimit=0
     DeathMessageClass=Class'3SPNCv42109e.Misc_DeathMessage'
     MutatorClass="3SPNCv42109e.TAM_Mutator"
     PlayerControllerClassName="3SPNCv42109e.Misc_Player"
     GameReplicationInfoClass=Class'3SPNCv42109e.TAM_GRI'
     GameName="ArenaMaster C v42109e"
